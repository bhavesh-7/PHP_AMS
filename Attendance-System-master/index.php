...
<html>
 ...
 <body>
  ...
  <div class="container">
    <h2>For Students</h2>
    <h4>Click here for <a href="student.php" target="_blank">Student Dashboard</a></h4>
    <hr>
    <h2>For Faculty</h2>
    ...
    <table class="table table-bordered table-striped">
     ...
     <!-- FOOTER -->
      <footer style="background:; height:120%;">
        ...
        <p>&copy;       PHP Project &middot;  developed by  <a href="https://www.instagram.com/bhavesh7.9/?next=%2F" target="_blank">Bhavesh Mishra </a></p>
      </footer>
